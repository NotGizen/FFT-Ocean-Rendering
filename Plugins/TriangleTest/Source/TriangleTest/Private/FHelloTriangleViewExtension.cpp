#include "FHelloTriangleViewExtension.h"
...
FHelloTriangleViewExtension::FHelloTriangleViewExtension(const FAutoRegister& AutoRegister) : FSceneViewExtensionBase(AutoRegister)
{
}
